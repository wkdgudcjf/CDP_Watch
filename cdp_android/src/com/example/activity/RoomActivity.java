...
public class RoomActivity extends Activity implements OnClickListener
{
	...
	//	mArrayList = MemberSetting.friendRequest(email);
	
		cl = new CustomAdapter(RoomActivity.this,R.layout.room_row,mArrayList);
			...
			btn_joinroom.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View arg0) 
				{
					...
					public void onClick(DialogInterface arg0, int arg1)
					{
						...
						{
							FollovDialog.showDialog("인터넷 접속 상태를 확인해 주세요.", RoomActivity.this);
						}
						else
						{
							//입장하는 코드 방입장.
